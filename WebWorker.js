...
self.onmessage = function (evt) {
  ...
  if (sMessagePurpose === "AddValues") {
    ...
    console.log('Passed compiled wasm');
    console.log(objData.WasmModule);
  ...
  else if (sMessagePurpose === "StartCounter") {
    ...
    g_timerId = setInterval(function() {
        seconds_elapsed = g_objInstance.exports._add(seconds_elapsed, 1);
        self.postMessage(seconds_elapsed);
    }, 1000);
  }

  else if (sMessagePurpose === "StopCounter") {
    g_isCancel = true;
